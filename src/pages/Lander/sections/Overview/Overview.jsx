...
const useCases = [
  "Wildfire detection",
  "Risk management",
  "Utility infrastructure insight",
  ...
  return (
    <section className="Overview">
      ...
      <div className="overview-info">
        ...
        <p>
          Perch offers a network of fire-detecting environmental sensors that
          mount to power lines. The sensor network provides a widely
